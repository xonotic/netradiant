...
#if !defined( INCLUDED_MODELBROWSER_H )
#define INCLUDED_MODELBROWSER_H
...
/// \brief Shows a modal dialog to choose a model from VFS.
/// Returns the selected model path (relative to VFS root), or nullptr if cancelled.
